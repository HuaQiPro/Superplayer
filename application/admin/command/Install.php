...
class Install extends Command
{
    ...
    protected function installation($mysqlHostname, $mysqlHostport, $mysqlDatabase, $mysqlUsername, $mysqlPassword, $mysqlPrefix, $adminUsername, $adminPassword, $adminEmail = null, $siteName = null)
    {
        ...
        // 检测能否成功写入数据库配置
        $dbConfigFile2 = APP_PATH . 'extra/zimu.php';
        $con = "<?php\nreturn [
    'type'            => 'mysql',
    'hostname'        => '".$mysqlHostname."', 
    'database'        => '".$mysqlHostport."', 
    'username'        => '".$mysqlUsername."', 
    'password'        => '".$mysqlPassword."', 
    'prefix'          => '".$mysqlPrefix."',
    ];";
        $result2 = @file_put_contents($dbConfigFile2, $con);
        if (!$result2) {
            throw new Exception(__('The current permissions are insufficient to write the file %s', 'application/extra/zimu.php'));
        }
