...
INSERT INTO `fa_auth_rule` VALUES (85, 'file', 0, 'play', '播放器', 'fa fa-youtube-play', '', '', '', 1, 'addtabs', '', 'bfq', 'bofangqi', 1659203710, 1659203755, 98, 'normal');
INSERT INTO `fa_auth_rule` VALUES (86, 'file', 85, 'play/play', '播放器列表', 'fa fa-circle-o', '', '', '', 1, 'addtabs', '', 'bfqlb', 'bofangqiliebiao', 1659799835, 1668697256, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (87, 'file', 85, 'play/jx', '高级设置', 'fa fa-circle-o', '', '', '', 1, 'addtabs', '', 'gjsz', 'gaojishezhi', 1668147706, 1668697271, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (88, 'file', 85, 'play/danmu', '弹幕列表', 'fa fa-circle-o', '', '', '', 1, 'addtabs', '', 'bfqlb', 'bofangqiliebiao', 1659203821, 1659203821, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (89, 'file', 88, 'play/danmu/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1659104766, 1659104810, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (90, 'file', 88, 'play/danmu/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1659104766, 1659104810, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (91, 'file', 88, 'play/danmu/edit', '编辑', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'bj', 'bianji', 1659104766, 1659104810, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (92, 'file', 88, 'play/danmu/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1659104766, 1659104810, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (93, 'file', 88, 'play/danmu/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1659104766, 1659104810, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (94, 'file', 86, 'play/play/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1659799835, 1659799835, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (95, 'file', 86, 'play/play/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1659799835, 1659799835, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (96, 'file', 86, 'play/play/edit', '编辑', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'bj', 'bianji', 1659799835, 1659799835, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (97, 'file', 86, 'play/play/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1659799835, 1659799835, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (98, 'file', 86, 'play/play/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1659799835, 1659799835, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (99, 'file', 85, 'play/ad', '封锁记录', 'fa fa-circle-o', '', '', '', 1, 'addtabs', '', 'fsjl', 'fengsuojilu', 1668697362, 1668706421, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (100, 'file', 85, 'play/zimu', '字幕管理', 'fa fa-circle-o', '', '', '', 1, 'addtabs', '', 'zmgl', 'zimuguanli', 1675769517, 1675769549, 0, 'normal');
COMMIT;

-- ----------------------------
-- Table structure for fa_zimu
-- ----------------------------
DROP TABLE IF EXISTS `fa_category`;
CREATE TABLE `fa_zimu` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '标题',
  `mid` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '字幕id',
  `text` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '字幕地址',
  PRIMARY KEY (`id`),
  KEY `mid` (`mid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='字幕列表';
...
CREATE TABLE `fa_ad` (
  ...
  `title` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '当日请求次数',
  `content` text COLLATE utf8mb4_unicode_ci COMMENT '异常内容',
  `createtime` bigint(16) DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint(16) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='封锁记录';

-- ----------------------------
-- Table structure for fa_danmu
-- ----------------------------
DROP TABLE IF EXISTS `fa_danmu`;
CREATE TABLE `fa_danmu` (
  `cid` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '弹幕池id',
  `type` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '弹幕类型',
  `text` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '弹幕内容',
  `color` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '弹幕颜色',
  `size` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '弹幕大小',
  `videotime` float(24,3) NOT NULL COMMENT '发布时间',
  `ip` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '用户ip',
  `createtime` int(10) NOT NULL COMMENT '发送时间',
  `status` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '状态:0=未审,1=已审核',
  PRIMARY KEY (`cid`),
  KEY `id` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='弹幕列表';

-- ----------------------------
-- Table structure for fa_play
-- ----------------------------
DROP TABLE IF EXISTS `fa_play`;
CREATE TABLE `fa_play` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '播放器名字',
  `code` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '播放器编码',
  `createtime` bigint(16) DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint(16) DEFAULT NULL COMMENT '更新时间',
  `status` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='播放器列表';

-- ----------------------------
-- Records of fa_play
-- ----------------------------
BEGIN;
INSERT INTO `fa_play` VALUES (3, '播放器3', 'qw', 1659799952, 1659800125, 'normal');
COMMIT;
